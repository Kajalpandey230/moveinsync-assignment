 ...
 * 
 * Displays a table of recently auto-closed alerts
 */
...
const AutoClosedAlertsTable = ({
  data,
  isLoading,
  error,
  onAlertClick,
}: AutoClosedAlertsTableProps) => {
  if (error) {
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="text-center py-8">
          <AlertCircle className="h-12 w-12 text-red-500 mx-auto mb-4" />
          <p className="text-red-600 font-medium">Error loading auto-closed alerts</p>
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-500">No auto-closed alerts in the last 24 hours</p>
        </div>
      </div>
    );
  }
