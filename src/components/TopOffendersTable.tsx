 ...
 * 
 * Displays a table of top drivers with most active alerts
 */

import { AlertTriangle, TrendingUp, Clock } from 'lucide-react';
import { TopOffender } from '../services/api';
...
const TopOffendersTable = ({ data, isLoading, error, onDriverClick }: TopOffendersTableProps) => {
  if (error) {
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="text-center py-8">
          <AlertTriangle className="h-12 w-12 text-red-500 mx-auto mb-4" />
          <p className="text-red-600 font-medium">Error loading top offenders</p>
